...
def main():
    ...
    while True:
        ...
        try:
            ...
            print("\n--- Answer ---")
            print(result["result"])
            # Check if any source documents were used
            ...
            if sources and not any(phrase in answer for phrase in fallback_phrases):
                print("\n--- Sources Used ---")
                ...
                # No relevant context found, or answer is a fallback phrase
                print("\nNo relevant information found in the database. Using general knowledge...")
